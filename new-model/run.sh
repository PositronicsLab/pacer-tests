git clean -dxf . ;
../setup-tests.sh *.in ;
${PACER_HOME}/debug/example/plugins/monte-carlo-simulation/sample.bin --duration 0 --xml --sample 1 \
  --BODY0.density 1956 \
  ...
  --RF_LEG_1.density 1200 --RF_LEG_1.length 0.021 --RF_LEG_1.radius 0.01 \
...
../randomize/place-robot.sh model-*.xml 
