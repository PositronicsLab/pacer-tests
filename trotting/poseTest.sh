...
read poseNum
FILE="/home/brad/Desktop/pacer-tests/new-model/PoseSet.txt"
...
Base_command_0=${myLineDelim[36]}
Base_command_1=${myLineDelim[37]}
Base_command_2=${myLineDelim[38]}
Base_command_3=${myLineDelim[39]}
Base_command_4=${myLineDelim[40]}
...
Base_command_3=${myLineDelim[39]}
Base_command_4=${myLineDelim[40]}
Base_command_5=${myLineDelim[41]}

echo "$line"

${PACER_COMPONENT_PATH}/monte-carlo-simulation/sample.bin --display --no-pipe --duration 2 --stepsize 0.0005 --sample 1 \
--BODY0.x 0.00290244 -1.11723e-06 0.160398 3.87869e-06 0.00335032 2.07803e-06 --BODY0.xd $Base_command_0 $Base_command_1 $Base_command_2 $Base_command_3 $Base_command_4 $Base_command_5 \
